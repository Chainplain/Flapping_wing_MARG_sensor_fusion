...
subplot(7,1,1);
hold on;
plot(Total_body_rotation_in_Euler_list_S{1}(:,3) ,"-",'LineWidth',LineWidth* Emph,'Color',LighGrayRed* 0.4);
plot(Total_body_rotation_in_Euler_list_S{2}(:,3),":",'LineWidth',LineWidth,'Color',LighGrayRed * 0.6);
plot(Total_body_rotation_in_Euler_list_S{3}(:,3),"-.",'LineWidth',LineWidth,'Color',LighGrayRed* 0.8);
plot(Total_desired_rotation_in_Euler_list_S{1}(:,3) ,"--",'LineWidth',LineWidth* Emph,'Color',LighGrayRed);
set(gca,'xtick',x_tick);
set(gca,'ytick',[-1,  0,  1]);
axis([0 x_tick(end) -1 1]);
grid on;
h = gca;
...
subplot(7,1,2);
hold on;
plot(Total_body_rotation_in_Euler_list_S{1}(:,2),"-",'LineWidth',LineWidth* Emph,'Color',LighGrayGreen* 0.4);
plot(Total_body_rotation_in_Euler_list_S{2}(:,2),":",'LineWidth',LineWidth,'Color',LighGrayGreen * 0.6);
plot(Total_body_rotation_in_Euler_list_S{3}(:,2),"-.",'LineWidth',LineWidth,'Color',LighGrayGreen* 0.8);
plot(Total_desired_rotation_in_Euler_list_S{2}(:,2),"--",'LineWidth',LineWidth* Emph,'Color',LighGrayGreen);
set(gca,'xtick',x_tick);
set(gca,'ytick',[-1,  0,  1]);
axis([0 x_tick(end) -1 1]);
grid on;
...
subplot(7,1,3);
hold on;
plot(Total_body_rotation_in_Euler_list_S{1}(:,1),"-",'LineWidth',LineWidth* Emph,'Color',LighGrayBlue* 0.4);
plot(Total_body_rotation_in_Euler_list_S{2}(:,1),":",'LineWidth',LineWidth,'Color',LighGrayBlue* 0.6);
plot(Total_body_rotation_in_Euler_list_S{3}(:,1),"-.",'LineWidth',LineWidth,'Color',LighGrayBlue* 0.8);
plot(Total_desired_rotation_in_Euler_list_S{2}(:,1),"--",'LineWidth',LineWidth* Emph,'Color',LighGrayBlue);
set(gca,'xtick',x_tick);
set(gca,'ytick',[-1,  0,  1]);
axis([0 x_tick(end) -1 1]);
grid on;
...
subplot(7,1,5);
hold on;
plot(Total_body_angular_velocity_list_S{1}(:,1),"-",'LineWidth',LineWidth * Emph,'Color',LighGrayRed* 0.4);
...
plot(Total_desired_angular_velocity_list_S{2}(:,1),"--",'LineWidth',LineWidth * Emph,'Color',LighGrayRed);
set(gca,'xtick',x_tick);
set(gca,'ytick',[-4, 0 4]);
axis([0 x_tick(end) -4 4]);
grid on;
h = gca;
set(h,'LineWidth',1,'GridLineStyle','--','GridAlpha',1,'GridColor',[0.9,0.9,0.9])
hold off;
...
subplot(7,1,6);
hold on;
plot(Total_body_angular_velocity_list_S{1}(:,2),"-",'LineWidth',LineWidth * Emph,'Color',LighGrayGreen* 0.4);
...
plot(Total_desired_angular_velocity_list_S{2}(:,2),"--",'LineWidth',LineWidth * Emph,'Color',LighGrayGreen);
set(gca,'xtick',x_tick);
% set(gca,'ytick',[-4, 0 4]);
axis([0 x_tick(end) -4 4]);
grid on;
...
subplot(7,1,7);
hold on;
plot(Total_body_angular_velocity_list_S{1}(:,3),"-",'LineWidth',LineWidth * Emph,'Color',LighGrayBlue* 0.4);
...
plot(Total_desired_angular_velocity_list_S{2}(:,3),"--",'LineWidth',LineWidth * Emph,'Color',LighGrayBlue);
set(gca,'xtick',x_tick);
% set(gca,'ytick',[-4, 0 4]);
axis([0 x_tick(end) -4 4]);
grid on;
...
set(gcf,'Position',[400,100,500,700]);
...
subplot(3,1,1);
hold on;
plot(Total_body_angular_velocity_list_S{1}(:,1),"-",'LineWidth',LineWidth* Emph,'Color',PatchRed_2 );
plot(Total_Angular_velocity_filtered_list_S{1}(:,1),"-",'LineWidth',LineWidth* Emph,'Color',PatchRed_2 * 0.5);
axis([0 x_tick(end) -4 4]);
grid on;
...
subplot(3,1,2);
hold on;
plot(Total_body_angular_velocity_list_S{1}(:,2),"-",'LineWidth',LineWidth* Emph,'Color',PatchGreen_2 );
...
subplot(3,1,3);
hold on;
plot(Total_body_angular_velocity_list_S{1}(:,3),"-",'LineWidth',LineWidth* Emph,'Color',PatchBlue_2 );
...
set(h,'LineWidth',1,'GridLineStyle','--','GridAlpha',1,'GridColor',[0.9,0.9,0.9])
hold off;
set(gcf,'Position',[400,100,500,400]);

Chosen = 1000:4000;

disp('tau_3 RMS');
disp(rms(Total_psi_rotation_error_list_S{1}(Chosen)))
disp('tau_1 RMS');
disp(rms(Total_psi_rotation_error_list_S{2}(Chosen)))
disp('tau_2 RMS');
disp(rms(Total_psi_rotation_error_list_S{3}(Chosen)))

disp('tau_3 MAX');
disp(max(Total_psi_rotation_error_list_S{1}(Chosen)))
disp('tau_1 MAX');
disp(max(Total_psi_rotation_error_list_S{2}(Chosen)))
disp('tau_2 MAX');
disp(max(Total_psi_rotation_error_list_S{3}(Chosen)))